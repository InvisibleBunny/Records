/*! UIkit 3.18.1 | https://www.getuikit.com | (c) 2014 - 2024 YOOtheme | MIT License */ (function (me, ve) {
  ...
  function p(t, e, i) {
    ...
    if (Y(i)) return (s = F(t)) == null ? void 0 : s.getAttribute(e);
    for (const n of C(t)) it(i) && (i = i.call(n, p(n, e))), i === null ? ye(n, e) : n.setAttribute(e, i);
  }
  function yt(t, e) {
  ...
  const ir = { area: !0, base: !0, br: !0, col: !0, embed: !0, hr: !0, img: !0, input: !0, keygen: !0, link: !0, meta: !0, param: !0, source: !0, track: !0, wbr: !0 };
  function Ui(t) {
  ...
  function Ji(t) {
    return (t[0] = Ki(t[0])), N(t[1]) && (t[1] = t[1].split(" ")), it(t[2]) && t.splice(2, 0, !1), t;
  }
  function hr(t, e) {
    return (i) => {
      const s =
  ...
  function c(t, e, i, s) {
    ...
    for (const o of n)
      if (N(e)) {
        if (((e = ri(e)), Y(i))) return getComputedStyle(o).getPropertyValue(e);
          ...
          (n) =>
            new Promise((o, r) => {
              ...
              H(
                ...
                [Qi, ts],
                ({ type: l }) => {
                  clearTimeout(a), O(n, Zi), c(n, { transitionProperty: "", transitionDuration: "", transitionTimingFunction: "" }), l === ts ? r() : o(n);
                },
                { self: !0 }
              ),
                $(n, Zi),
                c(n, { transitionProperty: Object.keys(e).map(ri).join(","), transitionDuration: `${i}ms`, transitionTimingFunction: s, ...e });
            })
        )
      )
    );
        ...
        (o) =>
          new Promise((r, a) => {
            ...
            H(
              ...
              [Vs, ai],
              ({ type: h }) => {
                clearTimeout(l), h === ai ? a() : r(o), c(o, "animationDuration", ""), qi(o, `${Pe}\\S*`);
              },
              { self: !0 }
            ),
  ...
  function Lt(t, e) {
    return Y(e) ? k(t).innerHTML : L(es(t), e);
  }
  const wr = ci("prepend"),
    L = ci("append"),
    li = ci("before"),
  ...
  function Wt(t) {
    ...
    return (i.innerHTML = t.trim()), Ys(i.content.childNodes);
  }
  function Ys(t) {
  ...
  function w(t) {
    const e = xe(t) ? F(t).getBoundingClientRect() : { height: et(t), width: di(t), top: 0, left: 0 };
  ...
  function Js(t) {
    ...
    return (i, s) => {
      if (Y(s)) {
        ...
        return (i = F(i)), (s = c(i, t)), (s = s === "auto" ? i[`offset${e}`] : S(s) || 0), s - Ae(i, t);
      } else return c(i, t, !s && s !== 0 ? "" : +s + Ae(i, t) + "px");
    };
  }
  function Ae(t, e, i = "border-box") {
    return c(t, "boxSizing") === i ? zt(jt[e].map(It), (s) => S(c(t, `padding${s}`)) + S(c(t, `border${s}Width`))) : 0;
  }
  function fi(t) {
  ...
  function q(t, e = "width", i = window, s = !1) {
    return N(t)
      ? zt($r(t), (n) => {
          const o = kr(n);
          return o ? Sr(o === "vh" ? Ir() : o === "vw" ? di(ne(i)) : s ? i[`offset${It(e)}`] : w(i)[e], n) : n;
        })
      : S(t);
  }
  ...
  let Oe, re;
  function Ir() {
    return Oe || (re || ((re = k("<div>")), c(re, { height: "100vh", position: "fixed" }), b(window, "resize", () => (Oe = null))), L(document.body, re), (Oe = re.clientHeight), at(re), Oe);
  }
  const qt = typeof window < "u",
    ...
    Ot = le ? "pointerup" : ae ? "touchend" : "mouseup",
    he = le ? "pointerenter" : ae ? "" : "mouseenter",
    De = le ? "pointerleave" : ae ? "" : "mouseleave",
  ...
  function ns(t) {
    Ks(K.reads), Ks(K.writes.splice(0)), (K.scheduled = !1), (K.reads.length || K.writes.length) && os(t + 1);
  }
  const Tr = 4;
  function os(t) {
    K.scheduled || ((K.scheduled = !0), t && t < Tr ? Promise.resolve().then(() => ns(t)) : requestAnimationFrame(() => ns(1)));
  }
  function Ks(t) {
    let e;
    for (; (e = t.shift()); )
    ...
    function s(r, a, l, h) {
      return new Promise((u) => {
        ...
        (function Ze() {
          ...
          (r.scrollTop = Math[a + ft > 0 ? "max" : "min"](r.scrollTop, d + (a + ft) * Bi)), Bi === 1 && (M === ft || !wt--) ? u() : ((M = ft), requestAnimationFrame(Ze));
        })();
      });
    }
    function n(r) {
  ...
  function fn(t, e, i) {
    (i = { attach: { element: ["left", "top"], target: ["left", "top"], ...i.attach }, offset: [0, 0], placement: [], ...i }), Q(e) || (e = [e, e]), I(t, pn(t, e, i));
  }
  function pn(t, e, i) {
    const s = gn(t, e, i),
  ...
  function Mr(t, e, { offset: i, attach: s }, n) {
    return gn(t, e, { attach: { element: bn(s.element, n), target: bn(s.target, n) }, offset: Nr(i, n) });
  }
  function Br(t, e, i) {
    return pn(t, e, { ...i, attach: { element: i.attach.element.map(xn).reverse(), target: i.attach.target.map(xn).reverse() }, offset: i.offset.reverse(), placement: i.placement.reverse(), recursion: !0 });
  }
  function bn(t, e) {
    const i = [...t],
      s = ht[e].indexOf(t[e]);
  ...
  const G = {};
  (G.events = G.watch = G.observe = G.created = G.beforeConnect = G.connected = G.beforeDisconnect = G.disconnected = G.destroy = fs),
    (G.args = function (t, e) {
      return e !== !1 && fs(e || t);
    }),
    (G.update = function (t, e) {
      return Fs(fs(t, it(e) ? { read: e } : e), "order");
    }),
  ...
  function $n(t, e, i) {
    return G.computed(it(t) ? t.call(i, i) : t, it(e) ? e.call(i, i) : e);
  }
  function fs(t, e) {
  ...
  function ps(t, e) {
    return t === Boolean ? Fi(e) : t === Number ? $t(e) : t === "list" ? Rr(e) : t === Object && N(e) ? ce(e) : t ? t(e) : e;
  }
  const jr = /,(?![^(]*\))/;
  function Rr(t) {
  ...
  function Ne(t, e = "update") {
    t._connected &&
      ...
      (t._queued ||
        ((t._queued = new Set()),
        K.read(() => {
          t._connected && Gr(t, t._queued), delete t._queued;
        })),
  ...
  function Fe(t = {}) {
    return ze({
      handler: function (e, i) {
        ...
        for (const o of C(it(s) ? s(this) : s))
          z('[loading="lazy"]', o)
            .slice(0, n - 1)
  ...
  function yn(t) {
    return {
      ...
      handler(e) {
        ...
        H(document, `${Ot} ${gi} scroll`, (n) => {
          const { x: o, y: r } = _t(n);
          ((n.type !== "scroll" && s && o && Math.abs(i.x - o) > 100) || (r && Math.abs(i.y - r) > 100)) &&
            setTimeout(() => {
              g(s, "swipe"), g(s, `swipe${Yr(i.x, i.y, o, r)}`);
            });
        });
      },
      ...t,
  ...
  var kn = {
    ...
    observe: [gs({ options: { childList: !0, attributes: !0, attributeFilter: ["style"] } }), ct({ target: ({ $el: t }) => [t, ...B(t)] })],
    update: {
      read() {
  ...
  function Sn(t, e, i, s = 0) {
    const n = xi(e, !0),
      ...
      l = a(async () => {
        $(e, bs), await Promise.all(Tn(e).map((u, d) => new Promise((f) => setTimeout(() => D.start(u, r, i / 2, "ease").then(f), d * s)))), O(e, bs);
      }),
      h = a(async () => {
        const u = et(e);
        ...
        const x = v.map(async (T, M) => {
          await Kr(M * s), await D.start(T, o, i / 2, "ease");
        });
        u !== f && x.push(D.start(e, { height: f }, i / 2 + v.length * s, "ease")),
          await Promise.all(x).then(() => {
            O(e, xs), n === xi(e) && (c(e, { height: "", alignContent: "" }), c(d, { opacity: "" }), delete e.dataset.transition);
          });
      });
  ...
  async function Zr(t, e, i) {
    ...
    await Promise.all(s.concat(e).map(D.cancel)), t(), (s = s.concat(B(e).filter((f) => !m(s, f)))), await Promise.resolve(), K.flush();
    const r = p(e, "style"),
  ...
  function Cn(t, e) {
    const i = c(t, "zIndex");
    return U(t) ? { display: "", opacity: e ? c(t, "opacity") : "0", pointerEvents: "none", position: "absolute", zIndex: i === "auto" ? Et(t) : i, ...En(t) } : !1;
  }
  function Qr(t, e, i) {
    const s = e.map((o, r) => (P(o) && r in i ? (i[r] ? (U(o) ? En(o) : { opacity: 0 }) : { opacity: U(o) ? 1 : 0 }) : !1)),
      n = s.map((o, r) => {
  ...
  const _ = { TAB: 9, ESC: 27, SPACE: 32, END: 35, HOME: 36, LEFT: 37, UP: 38, RIGHT: 39, DOWN: 40 };
  var ea = {
    mixins: [_n],
    args: "target",
    props: { target: String, selActive: Boolean },
    data: { target: "", selActive: !1, attrItem: "uk-filter-control", cls: "uk-active", duration: 250 },
    computed: { children: ({ target: t }, e) => z(`${t} > *`, e), toggles: ({ attrItem: t }, e) => z(`[${t}],[data-${t}]`, e) },
    watch: {
      toggles(t) {
        this.updateState();
    ...
    methods: {
      apply(t) {
        const e = this.getState(),
          i = On(t, this.attrItem, this.getState());
        ia(e, i) || this.setState(i);
      },
      getState() {
        return this.toggles.filter((t) => y(t, this.cls)).reduce((t, e) => On(e, this.attrItem, t), { filter: { "": "" }, sort: [] });
      },
  ...
  function On(t, e, i) {
    ...
    return (s || Y(o)) && (n ? (s ? (delete i.filter[""], (i.filter[n] = s)) : (delete i.filter[n], (ti(i.filter) || "" in i.filter) && (i.filter = { "": s || "" }))) : (i.filter = { "": s || "" })), Y(o) || (i.sort = [o, r]), i;
  }
  ...
  function ra(t, e, i) {
    return [...t].sort((s, n) => X(s, e).localeCompare(X(n, e), void 0, { numeric: !0 }) * (i === "asc" || -1));
  }
  function aa(t) {
  ...
  function Dn(t) {
    ...
    return (
      c(i, { overflowY: CSS.supports("overflow", "clip") ? "clip" : "hidden", touchAction: "none", paddingRight: di(window) - i.clientWidth || "" }),
      () => {
  ...
  var We = {
    ...
    Gt = {
      ...
      data: { cls: !1, animation: [!1], duration: 200, velocity: 0.2, origin: !1, transition: "ease", clsEnter: "uk-togglable-enter", clsLeave: "uk-togglable-leave" },
      computed: { hasAnimation: ({ animation: t }) => !!t[0], hasTransition: ({ animation: t }) => ["slide", "reveal"].some((e) => dt(t[0], e)) },
      methods: {
            ...
            return (
              await Promise.all(
                C(t).map((s) => {
                  ...
                  const o = (it(i) ? i : i === !1 || !this.hasAnimation ? la : this.hasTransition ? ha : ca)(s, n, this),
        ...
        isToggled(t = this.$el) {
          return (t = F(t)), y(t, this.clsEnter) ? !0 : y(t, this.clsLeave) ? !1 : this.cls ? y(t, this.cls.split(" ")[0]) : U(t);
        },
        _toggle(t, e) {
          if (!t) return;
          e = !!e;
          let i;
          this.cls ? ((i = m(this.cls, " ") || e !== y(t, this.cls)), i && j(t, this.cls, m(this.cls, " ") ? void 0 : e)) : ((i = e === t.hidden), i && (t.hidden = !e)),
            z("[autofocus]", t).some((s) => (U(s) ? s.focus() || !0 : s.blur())),
  ...
  async function ha(t, e, { animation: i, duration: s, velocity: n, transition: o, _toggle: r }) {
    ...
    const [l = "reveal", h = "top"] = ((a = i[0]) == null ? void 0 : a.split("-")) || [],
      ...
      M = `margin-${h}`;
    let wt = w(t)[x];
    const Ze = D.inProgress(t);
    await D.cancel(t), e && r(t, !0);
    const Bi = Object.fromEntries(["padding", "border", "width", "height", "minWidth", "minHeight", "overflowY", "overflowX", T, M].map((Zo) => [Zo, t.style[Zo]])),
      ft = w(t),
      ge = S(c(t, T)),
      Xo = S(c(t, M)),
      te = ft[x] + Xo;
    !Ze && !e && (wt += Xo);
    const [Ni] = is(t, "<div>");
    c(Ni, { boxSizing: "border-box", height: ft.height, width: ft.width, ...c(t, ["overflow", "padding", "borderTop", "borderRight", "borderBottom", "borderLeft", "borderImage", M]) }),
      c(t, { padding: 0, border: 0, minWidth: 0, minHeight: 0, [M]: 0, width: ft.width, height: ft.height, overflow: "hidden", [x]: wt });
    const Jo = wt / te;
    s = (n * te + s) * (e ? 1 - Jo : Jo);
    const Ko = { [x]: e ? te : 0 };
    f && (c(t, T, te - wt + ge), (Ko[T] = e ? ge : te + ge)), !f ^ (l === "reveal") && (c(Ni, T, -te + wt), D.start(Ni, { [T]: e ? 0 : -te }, s, o));
    try {
      await D.start(t, Ko, s, o);
    } finally {
    ...
    events: [
      {
        ...
        handler(t) {
          const { current: e, defaultPrevented: i } = t,
            { hash: s } = e;
          !i && s && oe(e) && !this.$el.contains(k(s)) ? this.hide() : E(e, this.selClose) && (t.preventDefault(), this.hide());
        },
      },
      {
        name: "toggle",
      ...
      },
      {
        ...
        handler() {
          ...
          const t = [this.overlay && da(this), this.overlay && Dn(this.$el), this.bgClose && fa(this), this.escClose && pa(this)];
          H(this.$el, "hidden", () => t.forEach((e) => e && e()), { self: !0 }), $(document.documentElement, this.clsPage);
        },
      },
      {
        name: "shown",
    ...
    return {
      ...
      show(u, d = 0, f) {
        ...
        return (
          ...
          new Promise((x) => {
            h || (h = x),
              Promise.all([D.start(e, l[1], u, v), D.start(t, l[0], u, v)]).then(() => {
                this.reset(), h();
              }, A);
          })
        );
      ...
      translate(u) {
        this.reset();
        const d = r(u, i);
        c(e, d[1]), c(t, d[0]), $i(e, "itemtranslatein", { percent: u, dir: i }), $i(t, "itemtranslateout", { percent: 1 - u, dir: i });
      },
      percent() {
        return o(t || e, e, i);
      },
    ...
    ma = {
      ...
      methods: {
        startAutoplay() {
          this.stopAutoplay(),
            (this.interval = setInterval(() => {
              this.stack.length || (this.draggable && E(this.$el, ":focus-within")) || (this.pauseOnHover && E(this.$el, ":hover")) || this.show("next");
  ...
  var wa = {
    ...
    events: [
      {
        ...
        handler(t) {
          !this.draggable || this.parallax || (!kt(t) && ba(t.target)) || t.target.closest(ke) || t.button > 0 || this.length < 2 || this.start(t);
        },
      },
      {
        name: "dragstart",
    ...
    methods: {
      ...
      move(t) {
        ...
        this.dragging || b(this.list, "click", zn, Re), t.cancelable && t.preventDefault(), (this.dragging = !0), (this.dir = e < 0 ? 1 : -1);
        ...
        ((this.index === s && this.prevIndex !== s) || d) && g(i[this.index], "itemshown", [this]),
          h && ((this.prevIndex = s), (this.index = o), u || (g(a, "beforeitemhide", [this]), g(a, "itemhide", [this])), g(l, "beforeitemshow", [this]), g(l, "itemshow", [this])),
        ...
        setTimeout(() => Pt(this.list, "click", zn, Re)), c(this.list, { userSelect: "" }), (this.drag = this.percent = null);
      },
    },
  };
  function Fn(t, e) {
  ...
  function ka(t) {
    t._hasComputed && (Ur(t, { read: () => $a(t, Wn(t)), events: ["resize", "computed"] }), Ia(), qe.add(t));
  }
  function Sa(t) {
  ...
  function jn(t, e, i) {
    ...
    (n = it(n) ? n.call(t, t) : n || t.$el), !(!n || (Q(n) && !n.length) || (h && !h.call(t))) && t._events.push(b(n, s, l ? (N(l) ? l : l.call(t, t)) : null, N(o) ? t[o] : o.bind(t), { passive: a, capture: r, self: u }));
  }
  function Ea(t) {
    t._observers = [];
  ...
  function qn(t, e) {
    ...
    it(s) && !pt(t, l) && Ln(t, l, () => s.call(t, t)), (n = N(n) ? t[n] : n.bind(t)), it(o) && (o = o.call(t, t));
    const h = pt(t, l) ? t[l] : s,
      u = i(h, n, o, a);
    it(s) && Q(t[l]) && u.unobserve && Hn(t, { handler: _a(u), immediate: !1 }, l), Rn(t, u);
  }
  function _a(t) {
    return (e, i) => {
  ...
  function Un(t) {
    ...
    for (const a in s) {
      const l = Mt(a);
      let h = X(n, l);
      Y(h) || ((h = s[a] === Boolean && h === "" ? !0 : ps(s[a], h)), !(l === "target" && dt(h, "_")) && (e[a] = h));
    }
    const r = ce(X(n, o), i);
    for (const a in r) {
      const l = we(a);
      Y(s[l]) || (e[l] = ps(s[l], r[a]));
    }
    return e;
  }
  const Oa = rt((t, e) => {
  ...
  function Da(t) {
    const { $options: e, $props: i } = t,
      { id: s, props: n, el: o } = e;
    if (!n) return;
    const { attributes: r, filter: a } = Oa(s, n),
      l = new MutationObserver((h) => {
        const u = Un(e);
        h.some(({ attributeName: d }) => {
          const f = d.replace("data-", "");
          return (f === s ? r : [we(f), we(d)]).some((v) => !Y(u[v]) && u[v] !== i[v]);
        }) && t.$reset();
      });
  ...
  function Ts(t) {
    t._connected || (Aa(t), de(t, "beforeConnect"), (t._connected = !0), Ta(t), qr(t), xa(t), Ea(t), Da(t), ka(t), de(t, "connected"), Ne(t));
  }
  function Cs(t) {
    t._connected && (de(t, "beforeDisconnect"), Ca(t), Vr(t), Pa(t), Sa(t), de(t, "disconnected"), (t._connected = !1));
  }
  let Ma = 0;
  function Vn(t, e = {}) {
    (e.data = za(e, t.constructor.options)), (t.$options = Be(t.constructor.options, e, t)), (t.$props = {}), (t._uid = Ma++), Ba(t), Na(t), ya(t), de(t, "created"), e.el && t.$mount(e.el);
  }
  function Ba(t) {
  ...
  function za({ data: t = {} }, { args: e = [], props: i = {} }) {
    ...
    for (const s in t) Y(t[s]) ? delete t[s] : i[s] && (t[s] = ps(i[s], t[s]));
    return t;
  }
  const ut = function (t) {
    Vn(this, t);
  };
  (ut.util = zr), (ut.options = {}), (ut.version = "3.18.1");
  const Fa = "uk-",
    Yt = "__uikit__",
    fe = {};
  function Gn(t, e) {
    ...
    return (n.id = s), (n.name = t), (i = n.install) == null || i.call(n, ut, n, t), ut._initialized && !n.functional && requestAnimationFrame(() => Ue(t, `[${s}],[data-${s}]`)), (fe[s] = n);
  }
  function Ue(t, e, i, ...s) {
    const n = Gn(t);
  ...
  var qa = {
        ...
        navItems(t) {
          for (const e of t) {
            ...
            if (vt(i)) {
              const r = $t(i),
                a = this.slides[r];
              a && (a.id || (a.id = Jt(this, a)), (o = a.id)), (n = this.t("slideX", S(i) + 1)), p(s, "role", "tab");
            } else this.list && (this.list.id || (this.list.id = Jt(this, this.list)), (o = this.list.id)), (n = this.t(i));
      ...
      methods: {
        updateNav() {
          ...
          for (const e of this.navItems) {
            ...
            if (vt(i)) {
              const o = $t(i) === t;
              j(e, this.clsActive, o), j(s, "uk-disabled", this.parallax), p(s, { "aria-selected": o, tabindex: o && !this.parallax ? null : -1 }), o && s && E(P(e), ":focus-within") && s.focus();
    ...
    Jn = {
      ...
      methods: {
        ...
        _show(t, e, i) {
          if (
            ((this._transitioner = this._getTransitioner(t, e, this.dir, { easing: i ? (e.offsetWidth < 600 ? "cubic-bezier(0.25, 0.46, 0.45, 0.94)" : "cubic-bezier(0.165, 0.84, 0.44, 1)") : this.easing, ...this.transitionOptions })),
            !i && !t)
          )
        ...
        _getTransitioner(t = this.prevIndex, e = this.index, i = this.dir || 1, s = this.transitionOptions) {
          return new this.Transitioner($e(t) ? this.slides[t] : t, $e(e) ? this.slides[e] : e, i * (V ? -1 : 1), s);
        },
      },
    };
  function Ua(t, e) {
  ...
  var Zn = {
      ...
      data: { animation: "slide", clsActivated: "uk-transition-active", Animations: ks, Transitioner: ga },
      computed: {
    ...
    to = {
      ...
      events: [
        ...
        },
        {
          name: "beforeitemshow",
          handler(t) {
            this.isToggled() || ((this.draggable = !1), t.preventDefault(), this.toggleElement(this.$el, !0, !1), (this.animation = Qn.scale), O(t.target, this.clsActive), this.stack.splice(1, 0, this.index));
          },
        },
        {
          name: "itemshow",
        ...
        },
        {
          ...
          async handler(t, e) {
            ...
            if (s === "image" || i.match(/\.(avif|jpe?g|jfif|a?png|gif|svg|webp)($|\?)/i)) {
              ...
              this.setItem(e, Ve("iframe", { src: `https://www.youtube${a[1] || ""}.com/embed/${a[2]}${a[3] ? `?${a[3]}` : ""}`, width: 1920, height: 1080, ...l, ...r }));
  ...
  var Ya = {
    ...
    functional: !0,
    args: ["message", "status"],
    data: { message: "", status: "", timeout: 5e3, group: "", pos: "top-center", clsContainer: "uk-notification", clsClose: "uk-notification-close", clsMsg: "uk-notification-message" },
    install: Xa,
    computed: {
    ...
    async connected() {
      ...
      await D.start(c(this.$el, this.startProps), { opacity: 1, [this.marginProp]: t }), this.timeout && (this.timer = setTimeout(this.close, this.timeout));
    },
    events: {
      click(t) {
    ...
    methods: {
      async close(t) {
        ...
        this.timer && clearTimeout(this.timer), t || (await D.start(this.$el, this.startProps)), e(this.$el);
      },
    },
  };
  function Xa(t) {
  ...
  const Ii = { x: Ti, y: Ti, rotate: Ti, scale: Ti, color: Es, backgroundColor: Es, borderColor: Es, blur: Kt, hue: Kt, fopacity: Kt, grayscale: Kt, invert: Kt, saturate: Kt, sepia: Kt, opacity: Za, stroke: Qa, bgx: oo, bgy: oo },
    { keys: so } = Object;
  var no = {
    mixins: [Si],
    props: ho(so(Ii), "list"),
    ...
    return (
      t === "x" || t === "y"
        ...
        : t === "scale" &&
          ...
          (n = (o) => {
            var r;
            return Ei([o]) ? q(o, "width", e, !0) / e[`offset${(r = o.endsWith) != null && r.call(o, "vh") ? "Height" : "Width"}`] : S(o);
          })),
  ...
  function oo(t, e, i, s) {
    ...
    if (Ye(e, "backgroundSize", "") === "cover") return tl(t, e, i, s);
    const r = {};
  ...
  var sl = {
    ...
    observe: [ms(), He({ target: ({ target: t }) => t }), ct({ target: ({ $el: t, target: e }) => [t, e, Dt(e, !0)] })],
    update: {
      read({ percent: t }, e) {
        if ((e.has("scroll") || (t = !1), !U(this.$el))) return !1;
        if (!this.matchMedia) return;
        const i = t;
        return (t = co(wi(this.target, this.start, this.end), this.easing)), { percent: t, style: i === t ? !1 : this.getCss(t) };
      },
      write({ style: t }) {
        if (!this.matchMedia) {
          this.reset();
  ...
  var fo = {
    ...
    observe: [ct({ target: ({ $el: t, parallaxTarget: e }) => [t, e], filter: ({ parallax: t }) => t }), He({ filter: ({ parallax: t }) => t })],
    computed: {
    ...
    update: {
      write() {
        ...
        const t = this.parallaxTarget,
          e = q(this.parallaxStart, "height", t, !0),
          i = q(this.parallaxEnd, "height", t, !0),
        ...
        if (~this.prevIndex) for (const x of new Set([this.index, this.prevIndex])) m([r, n], x) || (d(this.slides[x]), f(this.slides[x]));
    ...
    return {
      ...
      show(h, u = 0, d) {
        ...
        return (
          ...
          t && _s(this.getItemIn(!0), "itemout", { percent: 1 - u, duration: h, timing: f, dir: i }),
          new Promise((v) => {
            l || (l = v), D.start(o, { transform: W(-a * (V ? -1 : 1), "px") }, h, f).then(l, A);
          })
        );
      },
      cancel() {
      ...
      translate(h) {
        ...
        for (const x of B(o)) {
          ...
          _s(x, `itemtranslate${Ze ? "in" : "out"}`, { dir: i, percent: wt ? 1 - h : M ? h : T ? 1 : 0 });
        }
      },
      percent() {
  ...
  var al = {
    ...
    data: { center: !1, sets: !1, attrItem: "uk-slider-item", selList: ".uk-slider-items", selNav: ".uk-slider-nav", clsContainer: "uk-slider-container", Transitioner: ol },
    computed: {
      finite({ finite: t }) {
    ...
    methods: {
      ...
      updateActiveClasses(t = this.index) {
        ...
        for (const s of this.slides) {
          ...
          for (const o of z(Se, s)) pt(o, "_tabindex") || (o._tabindex = p(o, "tabindex")), p(o, "tabindex", n ? o._tabindex : -1);
        }
      },
      getValidIndex(t = this.index, e = this.prevIndex) {
  ...
  var cl = {
    ...
    ul = {
      ...
      data: { ratio: "16:9", minHeight: void 0, maxHeight: void 0, selList: ".uk-slideshow-items", attrItem: "uk-slideshow-item", selNav: ".uk-slideshow-nav", Animations: cl },
      watch: {
        list(t) {
      ...
      methods: {
        init(t) {
          ...
          !n ||
            ...
            (t.preventDefault(), (this.touched = new Set([this])), (this.placeholder = n), (this.origin = { target: e, index: Et(n), ...this.pos }), b(document, pi, this.move), b(document, Ot, this.end), this.threshold || this.start(t));
        },
        start(t) {
        ...
        move(t) {
          ...
          if ((Pt(document, pi, this.move), Pt(document, Ot, this.end), !this.drag)) return;
          pl();
          const t = this.getSortable(this.placeholder);
          this === t ? this.origin.index !== Et(this.placeholder) && g(this.$el, "moved", [this, this.placeholder]) : (g(t.$el, "added", [t, this.placeholder]), g(this.$el, "removed", [this, this.placeholder])),
  ...
  var ko = {
    ...
    methods: {
      positionAt(t, e, i) {
        ...
        const r = bl(t),
          a = w(t);
        c(t, { top: -a.height, left: -a.width }), fn(t, e, { attach: o, offset: s, boundary: i, placement: n, viewportOffset: this.getViewportOffset(t) }), r();
      },
      getPositionOffset(t) {
    ...
    methods: {
      show() {
        ...
        const i = p(this.$el, "title"),
          s = b(this.$el, ["blur", De], (o) => !kt(o) && this.hide());
        this.reset = () => {
      ...
      async hide() {
        ...
        E(this.$el, "input:focus") ||
          (clearTimeout(this.showTimer), this.isToggled(this.tooltip || null) && (await this.toggleElement(this.tooltip, !1, !1)), (t = this.reset) == null || t.call(this), at(this.tooltip), (this.tooltip = null));
      },
      async _show(t, e) {
        (this.tooltip = L(this.container, `<div id="${e}" class="uk-${this.$options.name}" role="tooltip"> <div class="uk-${this.$options.name}-inner">${t}</div> </div>`)),
          b(this.tooltip, "toggled", (i, s) => {
            ...
            const a = [H(document, `keydown ${mt}`, this.hide, !1, (l) => (l.type === mt && !this.$el.contains(l.target)) || (l.type === "keydown" && l.keyCode === _.ESC)), b([document, ...Vt(this.$el)], "scroll", n, { passive: !0 })];
  ...
  function kl(t) {
    ...
    return ["delay", "title"].reduce((n, o) => ({ [o]: X(e, o), ...n }), { ...ce(X(e, i), ["title"]), ...s });
  }
  var Sl = {
    mixins: [yi],
  ...
  function Tl(t, e) {
    const i = { data: null, method: "GET", headers: {}, xhr: new XMLHttpRequest(), beforeSend: A, responseType: "", ...e };
  ...
  function Cl(t, e) {
    return new Promise((i, s) => {
      ...
      b(n, "load", () => {
        n.status === 0 || (n.status >= 200 && n.status < 300) || n.status === 304 ? i(n) : s(gt(Error(n.statusText), { xhr: n, status: n.status }));
      }),
  ...
  var Eo = {
    ...
    update() {
      ...
      for (const e in this.items) {
        ...
        p(i, { role: R(i, "a") ? "button" : null, "aria-controls": s.id, "aria-expanded": n, "aria-disabled": !this.collapsible && t.length < 2 && n }),
  ...
  async function Dl(t, e, { content: i, duration: s, velocity: n, transition: o }) {
    var r;
    ...
    const h = zt(["marginTop", "marginBottom"], (d) => c(i, d)) + w(i).height,
      u = l / h;
    (s = (n * h + s) * (e ? 1 - u : u)), c(a, "height", l), await D.start(a, { height: e ? h : 0 }, s, o), _e(i), delete t._wrapper, e || Ai(i, !0);
  }
  function Ml(t) {
    const e = Dt(t, !0);
    let i;
  ...
  function Nl(t, e, { duration: i, transition: s, velocity: n }) {
    ...
    return c(t, "height", o), D.start(t, { height: 0, marginTop: 0, marginBottom: 0, paddingTop: 0, paddingBottom: 0, borderTop: 0, borderBottom: 0, opacity: 0 }, n * o + i, s);
  }
  var Po = {
      args: "autoplay",
      ...
      connected() {
        this.autoplay === "inview" && !yt(this.$el, "preload") && (this.$el.preload = "none"), R(this.$el, "iframe") && !yt(this.$el, "allow") && (this.$el.allow = "autoplay"), this.automute && rn(this.$el);
      },
      observe: [
        ze({
          filter: ({ $el: t, autoplay: e }) => e && an(t),
          handler([{ isIntersecting: t }]) {
            t || this.$el.webkitDisplayingFullscreen || document.fullscreenElement === this.$el ? nn(this.$el) : on(this.$el);
          },
          args: { intersecting: !1 },
  ...
  var Oo = {
    ...
    connected() {
      $(this.$el, "uk-drop", this.clsDrop), this.toggle && !this.targetEl && (this.targetEl = Ll(this)), (this._style = Li(this.$el.style, ["width", "height"]));
    },
    disconnected() {
    ...
    events: [
      ...
      },
      {
        ...
        handler() {
          ...
          const t = [Wl(this), jl(this), ql(this), this.autoUpdate && Do(this), this.closeOnScroll && Rl(this)];
          H(this.$el, "hide", () => t.forEach((e) => e && e()), { self: !0 }), this.bgScroll || H(this.$el, "hidden", Dn(this.$el), { self: !0 });
        },
      },
    ...
    methods: {
      ...
      position() {
        ...
        for (const [n, [o, r]] of i) this.axis !== o && m([o, !0], this.stretch) && c(this.$el, { [r]: Math.min(I(this.boundary[n])[r], t[n][r] - 2 * e), [`overflow-${o}`]: "auto" });
        ...
        for (const [n, [o, r, a, l]] of i)
          if (this.axis === o && m([o, !0], this.stretch)) {
            const h = Math.abs(this.getPositionOffset(this.$el)),
              u = I(this.target[n]),
              d = I(this.$el);
            c(this.$el, { [r]: (u[a] > d[a] ? u[this.inset ? l : a] - Math.max(I(this.boundary[n])[a], t[n][a] + e) : Math.min(I(this.boundary[n])[l], t[n][l] - e) - u[this.inset ? a : l]) - h, [`overflow-${o}`]: "auto" }),
  ...
  var Mo = {
    ...
    data: { align: V ? "right" : "left", clsDrop: "uk-dropdown", clsDropbar: "uk-dropnav-dropbar", boundary: !0, dropbar: !1, dropbarAnchor: !1, duration: 200, container: !1, selNavItem: "> li > a, > ul > li > a" },
    computed: {
      ...
      dropbarOffset({ target: t, targetY: e }, i) {
        const { offsetTop: s, offsetHeight: n } = J(e || t || i, i);
        return s + n + this.dropbarPositionOffset;
      },
      dropbarPositionOffset(t, e) {
        return q(c(e, "--uk-position-offset"));
      },
      dropContainer(t, e) {
    ...
    events: [
      ...
      },
      {
        ...
        handler(t) {
          ...
          const { current: i, keyCode: s } = t,
            n = this.getActive();
          s === _.DOWN && (n == null ? void 0 : n.targetEl) === i && (t.preventDefault(), (e = k(Se, n.$el)) == null || e.focus()), Bo(t, this.items, n);
        },
      },
      {
        name: "keydown",
        ...
        handler({ target: t }) {
          ...
          const e = this.getDropdown(t),
            i = () => {
              ...
              c(this.dropbar, "top", this.dropbarOffset), this.transitionTo(s - I(this.dropbar).top + S(c(t, "marginBottom")), t);
            };
      ...
      },
      {
        ...
        handler(t) {
          const e = this.getActive();
          E(this.dropbar, ":hover") && e.$el === t.target && m(e.mode, "hover") && e.isDelayedHide && !this.items.some((i) => e.targetEl !== i && E(i, ":focus")) && t.preventDefault();
        },
      },
      {
        name: "hide",
    ...
    methods: {
      ...
      async transitionTo(t, e) {
        ...
        c(e, "clipPath", `polygon(0 0,100% 0,100% ${s}px,0 ${s}px)`),
          et(i, s),
          await Promise.all([D.start(i, { height: t }, this.duration), D.start(e, { clipPath: `polygon(0 0,100% 0,100% ${t}px,0 ${t}px)` }, this.duration).finally(() => c(e, { clipPath: "", transitionDelay: "" }))]).catch(A);
      },
      getDropdown(t) {
        return this.$getComponent(t, "drop") || this.$getComponent(t, "dropdown");
      },
      isDropbarDrop(t) {
        return this.getDropdown(t) && y(t, this.clsDrop);
      },
      initializeDropdowns() {
        this.$create(
          "drop",
  ...
  function Bo(t, e, i) {
    ...
    let l = -1;
    a === _.HOME ? (l = 0) : a === _.END ? (l = "last") : a === _.LEFT ? (l = "previous") : a === _.RIGHT ? (l = "next") : a === _.TAB && ((s = i.targetEl) == null || s.focus(), (n = i.hide) == null || n.call(i, !1)),
      ~l && (t.preventDefault(), (o = i.hide) == null || o.call(i, !1), e[ot(l, e, e.indexOf(i.targetEl || r))].focus());
  }
  var Ul = {
      mixins: [st],
      args: "target",
    ...
    Vl = {
      ...
      data: { margin: "uk-grid-margin", clsStack: "uk-grid-stack", masonry: !1, parallax: 0, parallaxStart: 0, parallaxEnd: 0, parallaxJustify: !1 },
      connected() {
      ...
      update: [
        ...
        },
        {
          read(t) {
            ...
            if (((s = Math.max(0, q(s))), !(i || s || n) || No(e) || e[0].some((x, T) => e.some((M) => M[T] && M[T].offsetWidth !== x.offsetWidth)))) return (t.translates = t.scrollColumns = !1);
            let r = Yl(e, o),
              a,
              l;
            i ? ([a, l] = Gl(e, r, i === "next")) : (a = Xl(e));
            const h = a.map((x) => zt(x, "offsetHeight") + r * (x.length - 1)),
              u = Math.max(0, ...h);
            let d, f, v;
            return (
              (s || n) &&
                ((d = h.map((x, T) => (n ? u - x + s : s / (T % 2 || 8)))), n || (s = Math.max(...h.map((x, T) => x + d[T] - u))), (f = q(this.parallaxStart, "height", this.$el, !0)), (v = q(this.parallaxEnd, "height", this.$el, !0))),
              { columns: a, translates: l, scrollColumns: d, parallaxStart: f, parallaxEnd: v, padding: s, height: l ? u : "" }
            );
          },
  ...
  function Gl(t, e, i) {
    ...
    for (let a of t) {
      ...
      for (const h in a) {
        ...
        As(s, f, a[h]), As(n, f, [(f - h) * u * (V ? -1 : 1), o[f] - r]), (o[f] += d + e), (l = Math.max(l, d));
      }
      r += l + e;
    }
    return [s, n];
  ...
  var Jl = {
    ...
    observe: ct({ target: ({ $el: t, elements: e }) => e.reduce((i, s) => i.concat(s, ...s.children), [t]) }),
    update: {
      read() {
  ...
  function Kl(t) {
    ...
    let e = t.map(Zl);
    const i = Math.max(...e);
    return { heights: t.map((s, n) => (e[n].toFixed(2) === i.toFixed(2) ? "" : i - Ae(s, "height", "content-box"))), elements: t };
  }
  function Zl(t) {
    var e;
    const i = Li(t.style, ["display", "minHeight"]);
    U(t) || c(t, "display", "block", "important"), c(t, "minHeight", "");
    const s = (e = t.offsetHeight) != null ? e : t.clientHeight;
    return c(t, i), s;
  }
  var Ql = {
      args: "target",
  ...
  const Oi = {
    ...
    kh = {
      ...
      beforeConnect() {
        ...
        if (((this.icon = t ? "search-toggle-icon" : y(this.$el, "uk-search-icon") && oi(this.$el, ".uk-search-large") ? "search-large" : oi(this.$el, ".uk-search-navbar") ? "search-navbar" : this.$props.icon), !yt(this.$el, "aria-label")))
          if (t) {
  ...
  const Oh = { twitter: "x" };
  function Dh(t) {
    return (t = Oh[t] || t), Oi[t] ? (Di[t] || (Di[t] = k((Oi[Mh(t)] || Oi[t]).trim())), Di[t].cloneNode(!0)) : null;
  }
  function Mh(t) {
  ...
  var Nh = {
    ...
    connected() {
      ...
      Bh && Mi(this.$el) && ((this.$el.loading = "lazy"), Ds(this.$el)), Wh(this.$el);
    },
    disconnected() {
    ...
    methods: {
      load() {
        ...
        return ye(t, "loading"), Ds(this.$el, t.currentSrc), (this.img = t);
      },
    },
  };
  function Ds(t, e) {
  ...
  function Wh(t) {
    Mi(t) && !yt(t, "src") && p(t, "src", 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg"></svg>');
  }
  function Mi(t) {
    return R(t, "img");
  }
  var jh = {
    ...
    observe: [
      gs({ target: ({ target: t }) => t, options: { attributes: !0, attributeFilter: ["class"], attributeOldValue: !0 } }),
      {
        target: ({ target: t }) => t,
        observe: (t, e) => {
    ...
    update: {
      read() {
        for (const t of this.target) si(t, "uk-light,uk-dark", !this.selActive || E(t, this.selActive) ? Rh(t) : "");
      },
    },
  };
  function Rh(t) {
    ...
    Uh = {
      ...
      events: [
        ...
        },
        {
          ...
          self: !0,
          handler() {
            y(this.panel, "uk-margin-auto-vertical") ? $(this.$el, "uk-flex") : c(this.$el, "display", "block"), et(this.$el);
          },
        },
        {
          name: "hidden",
  ...
  function Vh({ modal: t }) {
    (t.dialog = function (i, s) {
      const n = t(`<div class="uk-modal"> <div class="uk-modal-dialog">${i}</div> </div>`, { stack: !0, role: "alertdialog", ...s });
      return (
        n.show(),
        b(
          n.$el,
      ...
      (t.confirm = function (i, s) {
        return e(
          ({ i18n: n }) =>
            `<form> <div class="uk-modal-body">${N(i) ? i : Lt(i)}</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-default uk-modal-close" type="button">${
              n.cancel
      ...
      (t.prompt = function (i, s, n) {
        const o = e(
            ({ i18n: l }) =>
              `<form class="uk-form-stacked"> <div class="uk-modal-body"> <label>${N(i) ? i : Lt(i)}</label> <input class="uk-input" value="${
                s || ""
              }" autofocus> </div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-default uk-modal-close" type="button">${l.cancel}</button> <button class="uk-button uk-button-primary">${
                l.ok
              }</button> </div> </form>`,
            n,
            () => null,
  ...
  var Gh = { extends: Eo, data: { targets: "> .uk-parent", toggle: "> a", content: "> ul" } };
  const Ms = "uk-navbar-transparent";
  var Yh = {
    extends: Mo,
    props: { dropbarTransparentMode: Boolean },
    data: { clsDrop: "uk-navbar-dropdown", selNavItem: ".uk-navbar-nav > li > a,a.uk-navbar-item,button.uk-navbar-item,.uk-navbar-item a,.uk-navbar-item button,.uk-navbar-toggle", dropbarTransparentMode: !1 },
    computed: {
      navbarContainer: (t, e) => e.closest(".uk-navbar-container"),
      dropbarOffset({ dropbarTransparentMode: t }) {
        const { offsetTop: e, offsetHeight: i } = this.navbarContainer;
        return e + (t === "behind" ? 0 : i + this.dropbarPositionOffset);
      },
    },
    watch: {
      items() {
    ...
    events: [
      {
        ...
        handler({ target: t }) {
          this.getTransparentMode(t) === "remove" && y(this.navbarContainer, Ms) && (O(this.navbarContainer, Ms), (this._transparent = !0));
        },
      },
      {
        name: "hide",
        ...
        async handler() {
          await Xh(), !this.getActive() && this._transparent && ($(this.navbarContainer, Ms), (this._transparent = null));
        },
      },
    ],
    methods: {
  ...
  var Qh = {
      ...
      update: {
        read() {
          return !this.content || !this.container || !U(this.$el) ? !1 : { max: Math.max(this.minHeight, et(this.container) - (w(this.content).height - et(this.$el))) };
        },
        write({ max: t }) {
    ...
    ec = {
      ...
      methods: {
        async scrollTo(t) {
          (t = (t && k(t)) || document.body), g(this.$el, "beforescroll", [this, t]) && (await un(t, { offset: this.offset }), g(this.$el, "scrolled", [this, t]));
        },
      },
    };
  const Ke = new Set();
  ...
  function Ro(t) {
    if (!t.defaultPrevented) for (const e of Ke) e.$el.contains(t.target) && oe(e.$el) && (t.preventDefault(), window.location.href !== e.$el.href && window.history.pushState({}, "", e.$el.href), e.scrollTo(Gi(e.$el)));
  }
  var nc = {
      args: "cls",
      props: { cls: String, target: String, hidden: Boolean, margin: String, repeat: Boolean, delay: Number },
      data: () => ({ cls: "", target: !1, hidden: !0, margin: "-1px", repeat: !1, delay: 0, inViewClass: "uk-scrollspy-inview" }),
    ...
    oc = {
      ...
      update: [
        {
          read() {
            const t = this.links.map(Gi).filter(Boolean),
              { length: e } = t;
    ...
    rc = {
      ...
      connected() {
        (this.start = qo(this.start || this.top)),
          ...
          (this.placeholder = k("+ .uk-sticky-placeholder", this.$el) || k('<div class="uk-sticky-placeholder"></div>')),
          (this.isFixed = !1),
          this.setActive(!1);
      },
      beforeDisconnect() {
        this.isFixed && (this.hide(), O(this.target, this.clsInactive)), Uo(this.$el), at(this.placeholder), (this.placeholder = null);
      },
      observe: [
        ms({
          handler() {
            q("100vh", "height") !== this._data.viewport && this.$emit("resize");
          },
        }),
            ...
            !location.hash ||
              ...
              setTimeout(() => {
                const e = I(k(location.hash)),
                  i = I(this.$el);
                this.isFixed && Wi(e, i) && (t.scrollTop = e.top - i.height - q(this.targetOffset, "height", this.placeholder) - q(this.offset, "height", this.placeholder));
              });
          },
        },
        {
      ...
      update: [
        {
          read({ height: t, width: e, margin: i, sticky: s }) {
            ...
            return (
              (s = a && !this.showOnUp && x + u === f && T === Math.min(a, Bs(!0, this.$el, 0, !0) - v - u + d) && c(P(this.$el), "overflowY") === "visible"),
              { start: x, end: T, offset: u, overflow: d, height: t, elHeight: v, width: e, margin: i, top: Rt(h)[0], sticky: s, viewport: o }
            );
          },
          write({ height: t, width: e, margin: i, offset: s, sticky: n }) {
            ...
            c(o, { height: t, width: e, margin: i }), (P(o) !== P(this.$el) || n ^ (Et(o) < Et(this.$el))) && ((n ? li : hi)(this.$el, o), (o.hidden = !0));
          },
          events: ["resize"],
        },
        {
          read({ scroll: t = 0, dir: e = "down", overflow: i, overflowScroll: s = 0, start: n, end: o, elHeight: r, height: a, sticky: l }) {
            ...
            return { dir: u, prevDir: e, scroll: h, prevScroll: t, below: h > I(d).top + (l ? Math.min(a, r) : a), offsetParentTop: I(d.offsetParent).top, overflowScroll: tt(s + tt(h, n, o) - tt(t, n, o), 0, i) };
          },
          write(t, e) {
      ...
      methods: {
        ...
        hide() {
          ...
          this.setActive(!1), O(this.$el, this.clsFixed, this.clsBelow), e ? c(this.$el, "top", t) : c(this.$el, { position: "", top: "", width: "", marginTop: "" }), (this.placeholder.hidden = !0), (this.isFixed = !1);
        },
        update() {
          ...
          if (!l) {
            let d = "fixed";
            e > o && ((r += o - a + s - i), (d = "absolute")), c(this.$el, { position: d, width: t, marginTop: 0 }, "important");
          }
  ...
  function Ns(t) {
    $(t, "uk-transition-disable"), requestAnimationFrame(() => O(t, "uk-transition-disable"));
  }
  var ac = {
    mixins: [Fo],
    args: "src",
    ...
    methods: {
      async getSvg() {
        return R(this.$el, "img") && !this.$el.complete && this.$el.loading === "lazy" && (await new Promise((t) => H(this.$el, "load", t))), hc(await lc(this.src), this.icon) || Promise.reject("SVG not found.");
      },
    },
  };
  function Vo(t) {
  ...
  const lc = rt(async (t) => (t ? (dt(t, "data:") ? decodeURIComponent(t.split(",")[1]) : (await fetch(t)).text()) : Promise.reject()));
  function hc(t, e) {
    return e && m(t, "<symbol") && (t = cc(t)[e] || t), (t = k(t.substr(t.indexOf("<svg")))), (t == null ? void 0 : t.hasChildNodes()) && t;
  }
  const Go = /<symbol([^]*?id=(['"])(.+?)\2[^]*?<\/)symbol>/g,
    cc = rt(function (t) {
      const e = {};
      Go.lastIndex = 0;
      let i;
      for (; (i = Go.exec(t)); ) e[i[3]] = `<svg ${i[1]}svg>`;
      return e;
    });
  function uc(t) {
    const e = io(t);
  ...
  var Yo = {
      ...
      data: { connect: "~.uk-switcher", toggle: "> * > :first-child", itemNav: !1, active: 0, cls: "uk-active", attrItem: "uk-switcher-item", selVertical: ".uk-nav", followFocus: !1, swiping: !0 },
      computed: {
      ...
      observe: [Fe({ targets: ({ connectChildren: t }) => t }), yn({ target: ({ connects: t }) => t, filter: ({ swiping: t }) => t })],
      events: [
        {
          name: "click keydown",
          delegate() {
      ...
      update() {
        ...
        for (const e in this.toggles) {
          ...
          p(i, "role", "tab"), s && ((i.id = Jt(this, i)), (s.id = Jt(this, s)), p(i, "aria-controls", s.id), p(s, { role: "tabpanel", "aria-labelledby": i.id }));
        }
  ...
  var pc = {
      ...
      events: [
        ...
        {
          name: `mouseenter mouseleave ${he} ${De} focus blur`,
          filter() {
            return m(this.mode, "hover");
          },
          handler(t) {
      ...
      methods: {
        async toggle(t) {
          ...
          if ((yt(this.$el, "aria-expanded") && p(this.$el, "aria-expanded", !this.isToggled(this.target)), !this.queued)) return this.toggleElement(this.target);
